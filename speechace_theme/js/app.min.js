...
/******/ 	var hotCurrentHash = "6060445238aef6086646"; // eslint-disable-line no-unused-vars
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var mainModule = function () {
		...
		var cacheDOM = function cacheDOM() {
			...
			self.sliderNav = (0, _jquery2.default)('.apps__bottom-description');
			self.sliderControl = (0, _jquery2.default)('.controls__wrapper');
			self.phoneItem = (0, _jquery2.default)('.preview__phone');
			self.contactInput = (0, _jquery2.default)('.modal form input, .modal form textarea');
			self.contactLabel = (0, _jquery2.default)('.modal form label');
			self.imgSlider = (0, _jquery2.default)('.img-slider');
			self.quotesSlider = (0, _jquery2.default)('.quotes');
			self.mobileMenu = (0, _jquery2.default)('.hamburger');
			self.menuWrapper = (0, _jquery2.default)('.nav__nav-wrapper');
			self.appsSlider = (0, _jquery2.default)('.preview__items-wrapper');
			self.singlePage = (0, _jquery2.default)('.single-page');
			return self;
		};
		...
		var anchorScroll = function anchorScroll() {
			(0, _jquery2.default)('[href = "#contact-us"]').addClass('contact-us');
			(0, _jquery2.default)('a').on('click', function (event) {
				if ((0, _jquery2.default)(this).hasClass('contact-us')) {
		...
		var contactFormInput = function contactFormInput() {
			cachedDOM.contactInput.on('focus', function () {
				(0, _jquery2.default)(this).parent().find('label').addClass('focus');
			});
	
			cachedDOM.contactInput.on('blur', function () {
				if ((0, _jquery2.default)(this).val() === '') {
					(0, _jquery2.default)(this).parent().find('label').removeClass('focus');
				}
			});
		};
		...
		var btnTriggerContactUs = function btnTriggerContactUs() {
			(0, _jquery2.default)('div[id^=\'btn-contact-us\']').click(function () {
				(0, _jquery2.default)('#contact-form').modal({
					show: true
				});
			});
		};
	
		var modalContactUs = function modalContactUs() {
			(0, _jquery2.default)('#contact-form').on('shown.bs.modal', function () {
		...
		var mobileMenu = function mobileMenu() {
			...
			(0, _jquery2.default)('.nav__nav-wrapper a').on('click', function (e) {
				e.stopPropagation();
				(0, _jquery2.default)('.hamburger--spring');
				cachedDOM.menuWrapper.removeClass('nav__nav-wrapper--opened');
			});
	
			(0, _jquery2.default)(document).on('click', function (e) {
				if ((0, _jquery2.default)('div[class^=\'nav__\']').has(e.target).length === 0) {
					cachedDOM.mobileMenu.removeClass('is-active');
					cachedDOM.menuWrapper.removeClass('nav__nav-wrapper--opened');
				}
			});
		...
		var whatWeDoSlider = function whatWeDoSlider() {
		...
		var appsSlider = function appsSlider() {
			var $window = (0, _jquery2.default)(window),
			    toggleSlick;
		...
		var page = function page() {
			(0, _jquery2.default)(window).on('load', function () {
				if (cachedDOM.singlePage.length > 0) {
					(0, _jquery2.default)('html').addClass('single-html');
				}
			});
		};
